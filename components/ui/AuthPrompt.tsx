      ...
      <View style={{ backgroundColor: "#0A0A0B", borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingBottom: 48 }}>
        ...
        <View style={{ paddingHorizontal: 24 }}>
          <View style={{
            ...
            <Ionicons name={icon as any} size={28} color="#C9A24B" />
          </View>

          <Text style={{ color: "#F4F1EA", fontSize: 22, fontWeight: "800", marginBottom: 10, letterSpacing: -0.3 }}>
            {title}
          </Text>
          <Text style={{ color: "rgba(244,241,234,0.55)", fontSize: 15, lineHeight: 23, marginBottom: 32 }}>
            {body}
          </Text>

          <TouchableOpacity
            onPress={goSignUp}
            style={{ backgroundColor: "#C9A24B", borderRadius: 14, paddingVertical: 17, alignItems: "center", marginBottom: 10 }}
          >
            <Text style={{ color: "#0A0A0B", fontWeight: "800", fontSize: 16 }}>{cta}</Text>
          </TouchableOpacity>

          <TouchableOpacity
            onPress={goSignIn}
            style={{ borderRadius: 14, paddingVertical: 15, alignItems: "center", borderWidth: 1.5, borderColor: "rgba(0,0,0,0.12)", marginBottom: 10, backgroundColor: "#17171A" }}
          >
            <Text style={{ color: "#F4F1EA", fontWeight: "600", fontSize: 15 }}>Se connecter</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={onClose} style={{ paddingVertical: 10, alignItems: "center" }}>
            <Text style={{ color: "rgba(244,241,234,0.55)", fontSize: 14 }}>Plus tard</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
